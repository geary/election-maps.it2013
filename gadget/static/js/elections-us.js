...
var elections = {
	...
	2012: {
		...
		general: {
			...
			parties: {
				'AIP': { color: color.green },
				'AmC': { color: color.green },
				'AmE': { color: color.green },
				'AmP': { color: color.green },
				'ATP': { color: color.green },
				'Cnl': { color: color.green },
				'Con': { color: color.green },
				'CST': { color: color.green },
				'DCG': { color: color.green },
				'Dem': { color: color.blue },
				'GOP': { color: color.red },
				'Grn': { color: color.green },
				'GRP': { color: color.green },
				'IAP': { color: color.green },
				'IGr': { color: color.green },
				'Ind': { color: color.green },
				'Inp': { color: color.green },
				'IPD': { color: color.green },
				'JP': { color: color.green },
				'Lib': { color: color.green },
				'LUn': { color: color.green },
				'Mnt': { color: color.green },
				'NLP': { color: color.green },
				'NMI': { color: color.green },
				'NPA': { color: color.green },
				'NPD': { color: color.green },
				'Obj': { color: color.green },
				'Oth': { color: color.green },
				'PAG': { color: color.green },
				'PEC': { color: color.green },
				'PFP': { color: color.green },
				'Prg': { color: color.green },
				'Pro': { color: color.green },
				'PSL': { color: color.green },
				'RP': { color: color.green },
				'SCL': { color: color.green },
				'SEP': { color: color.green },
				'Soc': { color: color.green },
				'SWP': { color: color.green },
				'Una': { color: color.green },
				'UST': { color: color.green },
				'WTP': { color: color.green },
				'WYC': { color: color.green },
				'': {}
			}
		}
	}
